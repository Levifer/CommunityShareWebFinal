...
function markersMakenEvent()
{
    ...
    for (var i = 0, length = evenement.length; i < length; i++) {
        ...
        (function(marker, data)
        {
            ...
            var inhoud = "<div id='Info'> <h5 id='facebookdata'>" + data.categorie + ": " + data.straatNaam + " " + data.gemeente + "</h5></br><p id='fbomschrijving'>" + data.omschrijving + "</p><p id='colorblack'>" + data.datum + "</p></br><a class='button' href='reacties.html'>Reageer</a></br><a class='button' onclick='postToWall()'>Sharen</a></div>";
...
function markersMakenSituatie()
{
    ...
    for (var i = 0, length = gevaar.length; i < length; i++)
    {
        ...
        (function(marker, data)
        {
            ...
            includeJS("//connect.facebook.net/en_US/all.js");
            includeJS('js/facebook.js');
            var inhoud = "<div id='Info'> <h5 id='facebookdata'>" + data.categorie + ": " + data.straatNaam + " " + data.gemeente + "</h5></br><p id='fbomschrijving'>" + data.omschrijving + "</p><p id='colorblack'>" + data.datum + "</p><a class='button' href='reacties.html'>Reageer</a></br><a class='button' onclick='postToWall()'>  Sharen  </a></div>";
            google.maps.event.addListener(marker, "click", function(e) {
                infoWindow.setContent(inhoud);
